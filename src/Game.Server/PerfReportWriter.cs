    ...
    public static string ToJson(PerfSnapshot snapshot, PerfBudgetConfig budget, BudgetResult result)
    {
        object payload = new
        {
            ...
            totals = new
            {
                ...
                visibilityCellsVisited = snapshot.TotalVisibilityCellsVisited,
                visibilityRaysCast = snapshot.TotalVisibilityRaysCast,
                aoiEntitiesConsidered = snapshot.TotalAoiEntitiesConsidered,
                redactionEntitiesEmitted = snapshot.TotalRedactionEntitiesEmitted,
                transitionSpawns = snapshot.TotalTransitionSpawns,
                transitionDespawns = snapshot.TotalTransitionDespawns,
            ...
            maxPerTick = new
            {
                ...
                visibilityCellsVisited = snapshot.MaxVisibilityCellsVisitedPerTick,
                visibilityRaysCast = snapshot.MaxVisibilityRaysCastPerTick,
                aoiEntitiesConsidered = snapshot.MaxAoiEntitiesConsideredPerTick,
                redactionEntitiesEmitted = snapshot.MaxRedactionEntitiesEmittedPerTick,
                transitionSpawns = snapshot.MaxTransitionSpawnsPerTick,
                transitionDespawns = snapshot.MaxTransitionDespawnsPerTick,
            ...
            avgPerTick = new
            {
                ...
                visibilityCellsVisited = snapshot.AvgVisibilityCellsVisitedPerTick,
                visibilityRaysCast = snapshot.AvgVisibilityRaysCastPerTick,
                aoiEntitiesConsidered = snapshot.AvgAoiEntitiesConsideredPerTick,
                redactionEntitiesEmitted = snapshot.AvgRedactionEntitiesEmittedPerTick,
                transitionSpawns = snapshot.AvgTransitionSpawnsPerTick,
                transitionDespawns = snapshot.AvgTransitionDespawnsPerTick,
